...
gem 'jekyll',             '~> 4.0.0'
# Need to replace unmaintained jekyll-assets with something like gem 'jekyll-minibundle'
gem 'jekyll-assets',       github: 'envygeeks/jekyll-assets', branch: 'master', group: :jekyll_plugins
